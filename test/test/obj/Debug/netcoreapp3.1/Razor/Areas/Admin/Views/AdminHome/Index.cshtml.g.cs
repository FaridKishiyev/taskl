#pragma checksum "C:\Users\Ferid\Desktop\Code Academy\BackEnd\test\test\Areas\Admin\Views\AdminHome\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "548d880047cf5c13ce93dc77e6725f2caf2571fc"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"548d880047cf5c13ce93dc77e6725f2caf2571fc", @"/Areas/Admin/Views/AdminHome/Index.cshtml")]
          ...
          <div class=""content-wrapper"">
              ...
              <div class=""col-xl-3 col-sm-6 grid-margin stretch-card"">
                <div class=""card"">
                  <div class=""card-body"">
                    ...
                    <h6 class=""text-muted font-weight");
            WriteLiteral(@"-normal"">
                      Potential growth
                    </h6>
                  </div>
                    ...
                    <div class=""row"">
                      ...
                      <div class=""col-3"">
                        <div class=""icon icon-box-danger"">
                          <span
                            class=""mdi mdi-arrow-bottom-left icon-");
            WriteLiteral(@"item""
                          ></span>
                        </div>
                      </div>
                    ...
                    <div class=""row"">
                      ...
                      <div class=""col-3"">
                        <div class=""icon icon-box-success"">
                          <span
                    ");
            WriteLiteral(@"        class=""mdi mdi-arrow-top-right icon-item""
                          ></span>
                        </div>
                      </div>
                    </div>
            ...
            WriteLiteral(@"-left"">
                    ...
                    >
                      ...
                      <div
                        class=""align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-x");
            WriteLiteral(@"l-0""
                      >
            ...
            WriteLiteral(@"   </div>
                          ...
                          <div class=""preview-item border-bottom"">
                            ...
                            >
                              <div class=""flex-grow"">
                                <h6 class=""preview-subject""");
            WriteLiteral(@">Broadcast Mail</h6>
                                <p class=""text-muted mb-0"">
                          ...
                          <div class=""preview-item"">
                            ...
                            <div
                           ");
            WriteLiteral(@"   class=""preview-item-content d-sm-flex flex-grow""
                            >
                              <div class=""flex-grow"">
                  ...
                  <div class=""card-body"">
                    ...
                    <div class=""row"">
                      ...
                      >
                        <i
            ");
            WriteLiteral(@"              class=""icon-lg mdi mdi-codepen text-primary ml-auto""
                        ></i>
                      </div>
                    </div>
                  </div>
  ...
  ");
            WriteLiteral(@"                          <td>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              />
                              <spa");
            WriteLiteral(@"n class=""pl-2"">Estella Bryan</span>
                            </td>
                            <td>02312</td>
                            <td>$14,500</td>
                            <td>Website</td>
   ...
   ");
            ...
            WriteLiteral(@"b-1 small"">View all</p>
                    </div>
                    <div class=""preview-list"">
                      <div class=""preview-item border-bottom"">
                        <div class=""preview-thumbnail"">
                        ...
                        <div class=""preview-item-content d-flex flex-grow"">
                          <div class=""flex-grow"">
                            ...
                            <p class=""text-muted"">
                        ");
            WriteLiteral(@"      Well, it seems to be working now.
                            </p>
                          </div>
                        </div>
                      </div>
      ...
      ");
            ...
            WriteLiteral(@"ct"">Ethel Kelly</h6>
                      ...
                      <div class=""preview-item border-bottom"">
                        ...
                        <div class=""preview-item-content d-flex flex-grow"">
                          <div class=""flex-grow"">
                            ...
                            >
                              <h6 class=""preview-su");
            WriteLiteral(@"bject"">Herman May</h6>
                ...
                <div class=""card"">
                  <div class=""card-body"">
                    ...
                    >
                      <div class=""item"">
                        <img
                          src=""assets/images/da");
            WriteLiteral("shboard/Rectangle.jpg\"");
            BeginWriteAttribute("alt", "\r\n                          alt=\"", 32363, "\"", 32396, 0);
            EndWriteAttribute();
            ...
            WriteLiteral(@"
                    ...
                    <div class=""progress progress-md portfolio-pro");
            WriteLiteral(@"gress"">
                      <div
